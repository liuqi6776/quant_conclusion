...
| **★ ENS-Rank-Hybrid** | LambdaMART+LSTM+ENH4 | **13.7%** | 🏆 **0.61** | 🛡️ **19.34%** | 🛡️ **-32.83%** | 🏆 **0.42** | 🏆 **+59.43%** | 🛡️ **最强防御与夏普平衡** |
| **★ ENS-MSE-Hybrid** | GBDT20+LSTM+ENH4 | 🏆 **10.7%** | 🏆 **0.4** | **21.72%** | **-41.37%** | 🏆 **0.26** | 🏆 **+44.68%** | 🏆 **全场最高进攻收益** |

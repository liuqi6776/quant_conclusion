...
| [longterm_2015_2026_report.md](./longterm_2015_2026_report.md) | **【2015–2026 全周期实证】当前生产最优量化策略 11.3 年历史大周期长回测研报**：三大前置排雷 + 连板微观熔断 + 债券黄金多资产协同 | ⚠️ **审查未通过 / 待整改 (Under Remediation)**（2026-09-07 审计发现：长期基准混淆为股票 000852.SZ、训练日历截断导致丢失 2023 前样本、账本先买后卖缺陷；数据已作废，重构中） |
| [sentiment_cycle_report.md](./sentiment_cycle_report.md) | **【短线微观情绪周期】五大情绪指标（涨停/连板/晋级/昨涨/大面）建模与“黄金窗口”实证研报**：六阶段状态机；只在黄金窗口重仓 | ⚠️ **审查未通过 / 待整改 (Under Remediation)**（2026-09-07 审计发现：P0 日内未来数据泄漏（D日收盘指标用于D日开盘撮合）、账本先买后卖资金倒置、只卖不买未落实、ADV/停牌口径漏洞；20.79% 虚高收益作废，重构中） |
| [sentiment_cycle_board_report.md](./sentiment_cycle_board_report.md) | **【情绪周期分板块实证】黄金窗口战法在沪深主板/创业板/科创板/北交所独立表现实证研报**：全流程排除 ST/退市标的；各板块独立运行黄金窗口动态控仓 | ⚠️ **审查未通过 / 待整改 (Under Remediation)**（2026-09-07 审计发现：存在同日未来数据泄漏、北交所30%限制硬卡为10%、账本执行缺陷；24.48% 虚高收益作废，重构中） |

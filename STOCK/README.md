...
| [longterm_2015_2026_report.md](./longterm_2015_2026_report.md) | **【2015–2026 全周期实证】当前生产最优量化策略 11.3 年历史大周期长回测研报**：三大前置排雷 + 连板微观熔断 + 债券黄金多资产协同 | ✅ **审计整改重测通过 (Audit Remediated & Verified)**（2015-05 泡沫顶峰起跑：累计总收益 -2.57%/年化 -0.23%/夏普 -0.01/波动率 19.82%/回撤 -67.12%，战胜官方中证1000基准 -24.34% 达 +21.77% 累计超额；较纯股票多头 -55.23% 获取 +52.66% Alpha） |
| [sentiment_cycle_report.md](./sentiment_cycle_report.md) | **【短线微观情绪周期】五大情绪指标（涨停/连板/晋级/昨涨/大面）建模与“黄金窗口”实证研报**：六阶段状态机；只在黄金窗口重仓 | ✅ **审计整改重测通过 (Audit Remediated & Verified)**（严格 D-1 决策 -> D 开盘执行零前瞻：黄金窗口实盘版年化 11.62%/夏普 0.82/最大回撤仅 -11.64%/胜率 55.34%；连续 SCS 控仓版年化 16.11%/夏普 0.90/回撤 -14.34%；大幅超越中证1000年化 4.34%/回撤 -39.22%） |
| [sentiment_cycle_board_report.md](./sentiment_cycle_board_report.md) | **【情绪周期分板块实证】黄金窗口战法在沪深主板/创业板/科创板/北交所独立表现实证研报**：全流程排除 ST/退市标的；各板块独立运行黄金窗口动态控仓 | ✅ **审计整改重测通过 (Audit Remediated & Verified)**（主板夏普最高 0.96/年化 11.18%/波动率仅 9.46%；创业板弹性最强年化 11.82%/回撤 -11.36%；北交所 30cm 弹性最高年化 13.41%/回撤 -18.64%；全市场自由优选兼顾年化 11.62%/夏普 0.82） |

...
| [longterm_2015_2026_report.md](./longterm_2015_2026_report.md) | **【2015–2026 全周期实证】当前生产最优量化策略 11.3 年历史大周期长回测研报**：2,751 交易日、136 期月度调仓、跨越 3 轮牛熊周期极限检验；三大前置排雷 + 连板微观熔断 + 债券黄金多资产协同 | 🏆 **跨周期终极定论**（11.3年全期相对中证1000净超额达 **+69.77%**；12个自然年中 **10年跑赢基准（胜率83.3%）**；波动率由基准 46.38% 砍半至 **19.98%**；2019-2026年化 **13.25%**；彻底证实非短期过拟合，具备工业级长期复利生命力） |
| [sentiment_cycle_report.md](./sentiment_cycle_report.md) | **【短线微观情绪周期】五大情绪指标（涨停/连板/晋级/昨涨/大面）建模与“黄金窗口”实证研报**：六阶段状态机（冰点/退潮空仓、回暖轻仓、发酵加仓、高潮重仓、分歧只卖不买）；只在黄金窗口重仓 | 🏆 **实盘夏普与收益质的飞跃**（2023–2026 严格样本外生产账本：年化收益率跃升至 **20.79%**、夏普比率达到 **1.90**、年化波动率仅 **9.91%**、最大回撤彻底压制在 **-9.45%**、累计总收益 **+100.14%** 翻倍；彻底规避 A 股 500 天退潮失血与大面踩踏） |
| [sentiment_cycle_board_report.md](./sentiment_cycle_board_report.md) | **【情绪周期分板块实证】黄金窗口战法在沪深主板/创业板/科创板/北交所独立表现实证研报**：全流程排除 ST/退市标的；各板块独立运行黄金窗口动态控仓 | 🏆 **板块进攻与防守定论**（创业板为短线情绪周期战法最强进攻引擎：年化 **24.48%**、夏普 **1.92**、回撤 **-9.48%**、总收益 **+123.53%**；全市场自由优选年化 **20.79%**、夏普 **1.90**、总收益 **+100.14%** 综合最优；主板波动率仅 **7.60%**、回撤 **-8.48%** 为大资金容量基石；科创板年化 **19.43%**、北交所年化 **17.21%**） |

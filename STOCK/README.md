...
| [defensive_asset_allocation.md](./defensive_asset_allocation.md) | 多资产避险：RS12 弱段持货基/国债/黄金/混合对比 | ⚠️ 已修正代码并重跑（2026-08-03 修复 MA20 前视/V4 公式；修复后 V0 收益最高 16.25%、V8 卡玛最优 0.94；上游 risk_control 基准待重估；脚本见 scripts/defensive_asset/） |

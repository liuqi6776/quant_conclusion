...
- [股票 STOCK](./STOCK/README.md)
  ...
  - [回撤控制：MA20 三档（risk_control）](./STOCK/risk_control.md) — ⚠️ 已修正同日前视并重跑（四轮审查：主基准 32.28%→16.04%，walk-forward 按 rb_next 选参、DD shadow NAV 无前视、止损锁存边沿计摩擦；含 2018-2019 独立 OOS）
